...
export type Command = 'погладить' | 'потрогать траву' | 'обнять' | 'поцеловать' | 'засосать' | 'укусить' | 'лизнуть' | 'херак' | 'отмудохать' | 'пятюня' | 'пожать руку' | 'закопать' | 'жамк' | 'съесть' | 'откусить' | 'аминь' | 'шишка';
