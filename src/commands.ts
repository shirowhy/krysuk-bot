...
export type Command = 'погладить' | 'потрогать траву' | 'обнять' | 'поцеловать' | 'засосать' | 'укусить' | 'херак' | 'отмудохать' | 'пятюня' | 'пожать руку' | 'закопать' | 'жамк' | 'съесть' | 'откусить' | 'шишка';
